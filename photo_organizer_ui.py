...
class PhotoOrganizerWindow(QMainWindow):
    ...
    def _build_run_page(self) -> QWidget:
        ...
        folder_layout.setRowMinimumHeight(2, 8)
        folder_layout.addWidget(QLabel("Destination folder"), 3, 0)
        ...
        folder_layout.addWidget(self.destination_label, 4, 0, 1, 2)
        ...
        folder_layout.setRowMinimumHeight(5, 8)
        folder_layout.addWidget(self.dry_run, 6, 0)
        folder_layout.addWidget(self.csv_log, 6, 1)
        ...
        folder_layout.addWidget(self.status_label, 7, 0, 1, 2)
        folder_layout.addWidget(self.progress, 8, 0, 1, 2)
        folder_layout.addWidget(self.stats_label, 9, 0, 1, 2)
